export const RadioComponent = ({ transform }: { transform?: string }) => {
  // 主体
  const WIDTH = 100;
    ...
    <g transform={transform}>
      ...
      >
        ...
        <path
          ...
          d={`M 0 ${TOP_BOTTOM_HEIGHT + MIDDLE_HEIGHT}
                  ...
                  H ${WIDTH - RECT_RADIUS} 
                  Q ${WIDTH} ${TOTAL_HEIGHT}, ${WIDTH} ${
            TOTAL_HEIGHT - RECT_RADIUS
          } 
      ...
      <path
        d={`
                ...
                L ${ANTENNA_LEFT + ANTENNA_X + ANTENNA_WIDTH} ${
          ANTENNA_WIDTH / 2
        }
                Q ${ANTENNA_LEFT + ANTENNA_X + ANTENNA_WIDTH / 2} 0, ${
          ANTENNA_LEFT + ANTENNA_X
        } ${ANTENNA_WIDTH / 2}
                Z
            `}
      />
